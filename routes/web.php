...
Route::prefix('singleplayer')->group(function () {
    ...
    Route::post('/{soloGame}/round', GetSoloGameRound::class);
    Route::middleware('player.user')->group(function () {
        Route::post('/games', StartSoloGame::class);
        Route::post('/{soloGame}/guess', SoloGameGuess::class);
    });
});
...
Route::prefix('players')->name('players')->group(function () {
    ...
    Route::middleware('player.user')->group(function () {
        Route::get('/{player}', GetPlayer::class)
            ->name('.get');
