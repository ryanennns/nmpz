...
class RoundFactory extends Factory
{
    ...
    public function withGuesses(): static
    {
        return $this->afterMaking(function (Round $round) {
            ...
            $round->player_one_score = Round::calculateScore($location->lat, $location->lng, $p1Lat, $p1Lng);
            $round->player_two_score = Round::calculateScore($location->lat, $location->lng, $p2Lat, $p2Lng);
        });
    }
}
